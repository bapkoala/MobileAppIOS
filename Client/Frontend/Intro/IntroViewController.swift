...
struct IntroViewControllerUX {
    ...
    static let CardSlides = ["tour-Welcome2", "tour-Privacy", "tour-Efficiency"]
    ...
    static let StartBrowsingButtonHeight = 65
    ...
    static let CardTitleWelcome2 = NSLocalizedString("Intro.Slides.Welcome2.Title", tableName: "Intro", value: "Welcome on Qwant mobile !", comment: "Title for the first panel 'Welcome' in the First Run tour.")
    static let CardTitlePrivacy = NSLocalizedString("Intro.Slides.Privacy.Title", tableName: "Intro", value: "Your life stays private", comment: "Title for the second panel 'Privacy' in the First Run tour.")
    static let CardTitleEfficiency = NSLocalizedString("Intro.Slides.Efficiency.Title", tableName: "Intro", value: "Fast and efficient searches", comment: "Title for the third panel 'Efficiency' in the First Run tour.")
    ...
    static let CardTextWelcome2 = NSLocalizedString("Intro.Slides.Welcome2.Description", tableName: "Intro", value: "With Qwant mobile, navigate quickly and enjoy the browser which respect your privacy", comment: "Description for the 'Welcome' panel in the First Run tour.")
    static let CardTextPrivacy = NSLocalizedString("Intro.Slides.Privacy.Description", tableName: "Intro", value: "Qwant neither look the site you visit nor your researshes. It fight again ad tracking and stays neutral", comment: "Description for the 'Privacy' panel in the First Run tour.")
    static let CardTextEfficiency = NSLocalizedString("Intro.Slides.Efficiency.Description", tableName: "Intro", value: "Qwant delivers the best results intantaneously. Search everything, freely", comment: "Description for the 'Efficiency' panel in the First Run tour.")
...
class IntroViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        for i in 0..<IntroViewControllerUX.NumberOfCards {
            let imageView = UIImageView(frame: CGRect(x: CGFloat(i)*scaledWidthOfSlide, y: 0, width: scaledWidthOfSlide, height: scaledWidthOfSlide))
        ...
        func addCard(title: String, text: String, introView: UIView) {
            ...
            titleLabel.snp.makeConstraints { (make ) -> Void in
                make.top.equalTo(introView).offset(-40)
        ...
        addCard(title: IntroViewControllerUX.CardTitleWelcome2, text: IntroViewControllerUX.CardTextWelcome2, introView: UIView())
        addCard(title: IntroViewControllerUX.CardTitlePrivacy, text: IntroViewControllerUX.CardTextPrivacy, introView: UIView())
        addCard(title: IntroViewControllerUX.CardTitleEfficiency, text: IntroViewControllerUX.CardTextEfficiency, introView: UIView())
    ...
    override func viewDidLayoutSubviews() {
        ...
        for i in 0..<IntroViewControllerUX.NumberOfCards {
            if let imageView = slideContainer.subviews[i] as? UIImageView {
                imageView.frame = CGRect(x: CGFloat(i)*scaledWidthOfSlide, y: 0, width: scaledWidthOfSlide, height: scaledHeightOfSlide / 1.3)
