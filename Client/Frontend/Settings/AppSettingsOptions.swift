...
class SendAnonymousUsageDataSetting: BoolSetting {
    init(prefs: Prefs, delegate: SettingsDelegate?) {
        super.init(
            prefs: prefs, prefKey: "settings.sendUsageData", defaultValue: false,
...
class OpenSupportPageSetting: Setting {
    init(delegate: SettingsDelegate?) {
        super.init(title: NSAttributedString(string: NSLocalizedString("Help", comment: "Show the support page from the Support section in the settings. see https://help.qwant.com/help/qwant-mobile/"), attributes: [NSForegroundColorAttributeName: UIConstants.TableViewRowTextColor]),
            delegate: delegate)
    }

    override func onClick(_ navigationController: UINavigationController?) {
        navigationController?.dismiss(animated: true) {
            if let url = URL(string: NSLocalizedString("settings.help.url", value: "https://help.qwant.com/help/qwant-mobile/?client=qwantbrowser", comment: "Help URL. See https://help.qwant.com/help/qwant-mobile/")) {
...
class PrivacyPolicySetting: Setting {
    override var title: NSAttributedString? {
        return NSAttributedString(string: NSLocalizedString("Privacy Policy", comment: "Show Qwant Browser Privacy Policy page from the Privacy section in the settings. See https://about.qwant.com/legal/privacy/"), attributes: [NSForegroundColorAttributeName: UIConstants.TableViewRowTextColor])
    }

    override var url: URL? {
        return URL(string: NSLocalizedString("settings.privacypolicy.url", value: "https://about.qwant.com/legal/privacy/?client=qwantbrowser", comment: "Privacy policy URL. See https://about.qwant.com/legal/privacy/"))
    }
