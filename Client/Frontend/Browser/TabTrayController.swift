...
// MARK: Selectors
    ...
    /* func didTapLearnMore() {
        ...
        // if let langID = Locale.preferredLanguages.first {
            let learnMoreRequest = URLRequest(url: NSLocalizedString("privatebrowsing.more.url", value: "https://about.qwant.com/?client=qwantbrowser", comment: "URL for more info about private ).asURL!)
